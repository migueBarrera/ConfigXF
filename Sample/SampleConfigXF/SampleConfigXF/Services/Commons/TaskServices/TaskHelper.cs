...
namespace SampleConfigXF.Services.Commons
{
    public class TaskHelper : ITaskHelper
    {
        ...
        public TaskHelper(IDialogsService dialogsService, IConnectivityService connectivityService)
        {
        ...
        {
            if (exception is HttpRequestException /*TODO || exception is ApiException*/)
            {
                await this.dialogsService.ShowAlertAsync(
